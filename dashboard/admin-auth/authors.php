                      ...
                      <?php
                        ...
                        ?>
                            ...
                            <td>
                                ...
                                <img src="../uploads/images/<?= htmlspecialchars($row['profile_image']) ?>" alt="Cover Image" style="width: 100px; height: 120px; border-radius: 0;">
                                <?php endif; ?>
                            </td>

                            <td>
                                <span>
                                <a href="editdelete.php?id=<?= $row['author_id'] ?>" class="btn btn-gradient-info btn-fw">Edit</a>
                                <a href="authordelete.php?id=<?= $row['author_id'] ?>" class="btn btn-gradient-danger btn-fw" onclick="return confirm('Are you sure you want to delete this eBook?');">Delete</a>
                                </span>
                            </td>
                            </tr>
                        <?php
